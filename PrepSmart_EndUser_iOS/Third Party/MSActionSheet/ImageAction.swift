...
class ImageAction: UIAlertController, UINavigationControllerDelegate  {
    ...
    // Button names
    var library:String = "Photo Library"
    var frontCamera:String = "Front Camera"
    var rearCamera:String = "Rear Camera"
        ...
        if let image = info[.originalImage] as? UIImage{
           ...
           /* PKCCropHelper.shared.degressBeforeImage = UIImage(named: "pkc_crop_rotate_left.png")
            ...
            DispatchQueue.main.async {
                ...
                PKCCropHelper.shared.isCropRate =  true
                let cropVC = PKCCropViewController(image)//UIImage(named: "image.jpeg")!)
                cropVC.delegate = self
                
              self.clientVC?.navigationController?.pushViewController(cropVC, animated: false)
               
               // self.clientVC?.present(cropVC, animated: false, completion: nil)
                 picker.dismiss(animated: false, completion: nil)
            }*/
