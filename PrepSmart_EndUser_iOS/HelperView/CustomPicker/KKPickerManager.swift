//
//  KKPickerManager.swift
//  SampleLineList_iOS
//
//  Created by Kaustubh Kulkarni on 18/07/18.
//  Copyright © 2018 AperoTechnologies. All rights reserved.
//

import UIKit

public typealias KKPickerCompletion = (_ cancel: Bool) -> Void
public typealias KKPickerDateCompletion = (_ date: Date?, _ cancel: Bool) -> Void
public typealias KKPickerValueIndexCompletion = (_ value: String?, _ index: Int, _ cancel: Bool) -> Void

open class KKPickerManager: NSObject, UIPickerViewDelegate, UIPickerViewDataSource {
    
    static let shared = KKPickerManager()
    ...
    @objc open func showPicker(title: String?, selected: Date?, completion:KKPickerDateCompletion?) {
    ...
    @objc open func showPicker(title: String?, selected: Date?, min: Date?, max: Date?, completion:KKPickerDateCompletion?) {
    ...
    @objc open func showPicker(title: String?, picker:((_ picker: UIDatePicker) -> Void)?, completion:KKPickerDateCompletion?) {
    ...
    @objc open func showPicker(title: String?, selected: String?, strings:[String], completion:KKPickerValueIndexCompletion?) {
    ...
    @objc open func showPicker(title: String?, view: UIView, completion:KKPickerCompletion?) {
        ...
        case .landscapeLeft, .landscapeRight:
            ...
            buttonX = alertView.view.frame.size.width - (image!.size.height * 2)
